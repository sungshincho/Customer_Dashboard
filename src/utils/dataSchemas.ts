...
export const SALES_SCHEMA: DataSchema = {
  type: 'sales',
  columns: [
    { name: 'transaction_id', type: 'string', required: false, description: '거래 고유 ID', examples: ['주문번호', 'order_id', 'transaction'] },
    { name: 'timestamp', type: 'date', required: false, description: '거래 시간', examples: ['기간', '날짜', 'date', 'time', '주문시각'] },
    { name: 'product_name', type: 'string', required: true, description: '상품명', examples: ['상품명', 'product', 'item', '품목'] },
    { name: 'product_category', type: 'string', required: false, description: '상품 카테고리', examples: ['카테고리', 'category', '분류'] },
    { name: 'price', type: 'number', required: true, description: '판매 가격', examples: ['가격', 'price', '단가', '상품가격'] },
    { name: 'quantity', type: 'number', required: true, description: '판매 수량', examples: ['수량', 'quantity', '판매건수', 'count'] },
    { name: 'total_amount', type: 'number', required: false, description: '총 금액', examples: ['총금액', 'total', '실판매금액', 'amount'] },
    { name: 'discount', type: 'number', required: false, description: '할인 금액', examples: ['할인', 'discount', '할인금액'] },
    { name: 'customer_id', type: 'string', required: false, description: '고객 ID' },
