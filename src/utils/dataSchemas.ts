...
export const SALES_SCHEMA: DataSchema = {
  type: 'sales',
  columns: [
    { name: 'transaction_id', type: 'string', required: true, description: '거래 고유 ID' },
    { name: 'timestamp', type: 'date', required: true, description: '거래 시간' },
    { name: 'product_name', type: 'string', required: true, description: '상품명' },
    { name: 'product_category', type: 'string', required: false, description: '상품 카테고리' },
    { name: 'price', type: 'number', required: true, description: '판매 가격' },
    { name: 'quantity', type: 'number', required: true, description: '판매 수량' },
