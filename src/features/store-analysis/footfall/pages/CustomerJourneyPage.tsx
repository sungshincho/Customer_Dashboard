        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2 pt-4 border-t">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      variant={showZoneTransitions ? "default" : "outline"}
                      size="sm"
                      onClick={() => setShowZoneTransitions(!showZoneTransitions)}
                      className="w-full justify-start"
                    >
                      {showZoneTransitions ? "✓" : ""} 존 전환 확률
                    </Button>
                    <Button
                      variant={showDwellTime ? "default" : "outline"}
                      size="sm"
                  ...
                  <div className="space-y-2 pt-4 border-t">
                    ...
                    <div className="space-y-2">
                      <div className="text-xs text-muted-foreground">
                        총 전환: {zoneTransitionStats.totalTransitions}회
                      </div>
                      {zoneTransitionStats.topTransitions.slice(0, 3).map((t, idx) => (
                ...
                {showDwellTime && (
                  <div className="space-y-2 pt-4 border-t">
                    ...
                    <div className="space-y-2">
                      <div className="text-xs text-muted-foreground">
                        전체 평균: {Math.round(dwellTimeStats.overallAvgDwellTime / 60)}분
                      </div>
                      {dwellTimeStats.zoneDwellTimes.slice(0, 3).map((d, idx) => (
                        <div key={idx} className="p-2 rounded bg-muted text-xs">
                          <div className="flex items-center justify-between mb-1">
            ...
            <Card className="md:col-span-3">
              <CardHeader>
                <CardTitle>3D 고객 여정 분석</CardTitle>
                <CardDescription>
                  {paths.length > 0 
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs">
                    ...
                    {showZoneTransitions && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>전환 확률 (두께/색상)</span>
                      </div>
                    )}
                    {showDwellTime && (
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-6 bg-gradient-to-t from-blue-500 to-red-500" />
                        <span>체류 시간 (높이/색상)</span>
                      </div>
                    )}
                  </div>
                </div>
          ...
          {/* 하단: 상세 통계 차트 */}
          {(showZoneTransitions || showDwellTime) && (
            <div className="grid md:grid-cols-2 gap-6">
              {showZoneTransitions && (
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">전환 확률 분포</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              {showDwellTime && (
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">체류 시간 분포</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={200}>
