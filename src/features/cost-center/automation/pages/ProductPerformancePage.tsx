...
const ProductPerformancePage = () => {
  ...
  const comparisonData = [
    { label: "총 판매량", current: 1850, previous: 1620, unit: "개" },
    { label: "평균 객단가", current: 45000, previous: 42000, unit: "원" },
    { label: "재고 회전율", current: 8.5, previous: 7.2, unit: "회" }
  ];
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between animate-fade-in">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">판매량, 매출, 재고 통합 관리 (온톨로지 통합)</p>
          </div>
