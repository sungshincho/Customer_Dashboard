...
## 개요
NEURALTWIN 프로젝트를 Feature-based 폴더 구조로 재구성하고, 2025-11-14에 중복 코드 제거 완료했습니다.

## ✅ 2025-11-14 클린업 완료
- 29개의 중복/불필요 파일 삭제
- 호환성 레이어 제거 (src/pages/ 폴더)
- 중복 컴포넌트 제거 (src/components/analysis/, etl/, graph/, schema/)
- 전체 import 경로 feature-based 구조로 통합
- 상세 내역: [CLEANUP_2025_11_14.md](./CLEANUP_2025_11_14.md)
